...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  /* —— Series navigation —— */
  .series-nav { display: flex; flex-wrap: wrap; gap: 8px;
                font-size: 12px; letter-spacing: 0.04em;
                margin: 0 0 28px; padding-bottom: 18px;
                border-bottom: 1px solid var(--rule); }
  .series-nav a, .series-nav span { padding: 5px 11px; border-radius: 4px;
                                     text-decoration: none; }
  .series-nav a { color: var(--accent); border: 1px solid var(--rule); }
  .series-nav a:hover { background: rgba(0,0,0,0.04); }
